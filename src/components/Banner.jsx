...
const Banner = () => {
  ...
  return (
    <>
      <div className="min-h-[550px] bg-gray-100 dark:bg-gray-900 dark:text-white">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <div>
                  <button className="bg-gradient-to-r from-primary to-secondary text-white py-2 px-4 rounded-full shadow-xl hover:shadow-lg">
                    Order Now
                  </button>
                </div>
              </div>
